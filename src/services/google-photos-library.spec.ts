...
describe("GooglePhotosLibrary", () => {
  beforeAll(() => {
    ...
    const stubGetAlbums = sandbox.stub(GooglePhotosLibrary.prototype, "getAlbums");
    ...
    const stubCreateAlbum = sandbox.stub(GooglePhotosLibrary.prototype, <any>"createAlbum");
  ...
  describe("albums", () => {
    it("should return the albums", async () => {
      ...
      expect(response.albums.pop()).toEqual({ id: "2", productUrl: "", title: "Title 2" });
    });
